...
//    public static String uploadFolder = getRequest().getServletContext().getRealPath("/");
    public static String uploadFolder = "D:\\java4\\Shareprj\\shareprj\\src\\main\\webapp\\resources\\img\\";
...
//			out.clear();
    ...
    public static void deleteFile(String saveFileName, String path) {
        try {
            File file = new File(uploadFolder + path + "\\" + URLDecoder.decode(saveFileName, "UTF-8"));
