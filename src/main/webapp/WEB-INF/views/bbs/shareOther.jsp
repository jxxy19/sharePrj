        ...
        <div class="col-md-8">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="register-tab" data-bs-toggle="tab" data-bs-target="#register-tab-pane" type="button" role="tab" aria-controls="register-tab-pane" aria-selected="true" onclick="window.location.href='/bbs/shareMine'">내가 한 공유</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="like-tab" data-bs-toggle="tab" data-bs-target="#like-tab-pane" type="button" role="tab" aria-controls="like-tab-pane" aria-selected="false" onclick="window.location.href='/bbs/shareOther'">내가 받은 공유</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="like-tab-pane" role="tabpanel" aria-labelledby="register-tab" tabindex="0">
                    <form action="/bbs/shareOther" method="get" class="mt-5">
                        ...
                        <div class="table-responsive">
                            <table class="table no-wrap user-table custom-table mb-0 text-center">
                                ...
                                <tr scope="row" class="align-middle">
                                    ...
                                    <th scope="col" class="border-0">공유자</th>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <tr>
                                            <td class="text-center" colspan="4">회원정보가 없습니다.</td>
                                        </tr>
                                    </c:otherwise>
                                </c:choose>
                                </tbody>
